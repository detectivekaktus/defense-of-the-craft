...
public class DotcMusicSounds {
    public static SoundEvent RADIANT_THEME = DotcSounds.register("music_radiant_theme");
    public static ResourceKey<JukeboxSong> RADIANT_THEME_KEY = ResourceKey.create(
